    ...
    <script>
        ...
        ;(function(){
            ...
            $.getScript('//cdn.bootcss.com/prettify/r298/prettify.min.js', function(){
                ...
                // 解決Firefox瀏覽器壹個很詭異的問題
                // 當代碼高亮後，ol的行號莫名其妙的錯位
                // 但是只要刷新li裏面的html重新渲染就沒有問題了
...
<head>
    ...
    <title>系統發生錯誤</title>
    <!-- Bootstrap core CSS -->
    <link href="/static/500/css/bootstrap.css" rel="stylesheet">
    <!-- FONT AWESOME CSS -->
    <link href="/static/500/css/font-awesome.min.css" rel="stylesheet" />
    <!--GOOGLE FONT -->

    <!-- custom CSS here -->
    <link href="/static/500/css/style.css" rel="stylesheet" />
...
<script src="/static/500/js/custom.js"></script>
<script src="/static/500/js/bootstrap.js"></script>
<script src="/static/500/js/countUp.js"></script>
</body>
</html>
